        ...
        return (
          <div>
            ...
            <Row style={{ padding: 20 }}>
              ...
              <Col xs={7}>
                <h2>
                  TrustBasket Neem Cake Powder Organic Fertilizer and Pest
                  Repellent for Plants (450 GMS)
                </h2>
                ...
                <Button
                    style={{ height: 50, width: 200, backgroundColor: "gray",color:"white", fontWeight: "bold" }}>
                     <HeartOutlined style={{ fontSize: 18 }} />ADD TO WISHLIST
                    </Button>
              </Col>
              <Col xs={4}>
                {/* <Card>
